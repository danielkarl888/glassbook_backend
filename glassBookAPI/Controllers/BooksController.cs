...
namespace glassBookAPI.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public IEnumerable<Book> GetAllBooks()
        {
            ...
            {
                Book book = new Book();
                book.Book_name = "server error - please try again";
                books.Add(book);
                return books;
        ...
        [HttpGet("avg/{id}")]
        public ActionResult GetBookAvgRating(string id)
        {
            bool b = false;
            ...
            {
                Dictionary<string, object> row = new Dictionary<string, object>();
                row.Add("avg_rate", "error with the server");
                rows.Add(row);
                return Ok(rows);
            }
        }
        ...
        // GET a book's last comments
        [HttpGet("{id}")]
        public ActionResult GetBookComments(string id)
        {
            bool b = false;
            List<Dictionary<string, object>> rows = new List<Dictionary<string, object>>();
            try
        ...
        // get the all books that his name/author name connists a certain search text, ordered by their avg rate
        ...
        public IEnumerable<Search_Book> GetByText(string search)
        {
            ...
            {
                Search_Book book = new Search_Book();
                book.Author_name = "error with the server - try again";
                books.Add(book);
                return books;

            }
        }
        // get the 10 best books for a certain country 
        ...
        // get the 10 best books for a certain Category 
